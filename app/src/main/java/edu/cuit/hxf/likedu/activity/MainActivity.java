...
public class MainActivity extends FragmentActivity {
	...
	// 定义一个数组来存放Fragment界面
	private Class fragmentArray[] = { BookShelfFrag.class, SeekFrag.class,
			MeFrag.class };
	// 定义数组来存放按钮图片
	private int mImageViewArray[] = { R.drawable.tab_finding,
			R.drawable.tab_recording, R.drawable.tab_me };
	// Tab选项卡的文字
	private String mTextViewArray[] = { "书架", "发现", "我的" };
